# Цикли. Оператори за цикъл. Оператори `break` и `continue`.
...
<img src="assets/while_loops.jpg" alt="while vs. do-while diagram" width="600" />
...
2. Изчислява се стойността на условие (true / false).
3. Ако условието е false, for цикълът приключва.
4. Ако условието е true, тялото на цикъла се изпълнява.
5. Изпълнява се промяната.
6. Повтаря се стъпка 2.
