...
**Задача 27:** Да се провери дали естественото число А се дели на простите делители на B, което е със същите цифри на А, но записани в обратен ред.
...
**Задача 28:** Напишете функция, която изчислява квадратния корен на **n**, без да използва стандартната библиотечна функция `sqrt`.
