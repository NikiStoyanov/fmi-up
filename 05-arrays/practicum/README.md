...
**Задача 15:** Да се напише функция, която приема масив от цели числа и връща дали е симетричен.
...
**Задача 16:** Да се състави програма, която проверява, дали в редицата от цели числа а<sub>0</sub>, а<sub>1</sub>, а<sub>2</sub>, …, а<sub>n - 1</sub> [ 0 < n <= 50 ] съществуват два последователни нулеви елемента.
...
**Задача 17:** Напишете функция, която намира второто най-голямо число в масив.
...
**Задача 18:** Създайте програма, която прочита от стандартния вход цяло положително число **N** ∈ [2, 1024] - дължина на масив от цели числа, а след това и неговите елементи.
